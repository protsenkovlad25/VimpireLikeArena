...
namespace VampireLike.Core.Characters.Enemies.SpikyEnemy
{
    public class SpikyEnemy : GameCharacterBehaviour, INeedingWeapon, INeeding<IAttaching>
    {
